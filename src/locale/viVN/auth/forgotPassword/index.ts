export default {
  ...
  'forgot.password.title.reset': 'Đặt lại mật khẩu mới',
  'forgot.password.description':
    'Vui lòng email để đặt lại mật khẩu của bạn',
  ...
  'forgot.password.button.next': 'Tiếp tục',
  'forgot.password.button.accept': 'Xác nhận',
  'forgot.password.button.cancel': 'Hủy',
