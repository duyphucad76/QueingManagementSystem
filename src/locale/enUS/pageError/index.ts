export default {
  'common.page.notfound': 'We did not find this page',
  ...
  'common.404note':
    'It seems something is disconnected.Don\'t find the page you requested, but there are several ways to take you back in the right direction. You can return to the previous page or visit our homepage.',
